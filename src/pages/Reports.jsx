  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-text-secondary">View and download system reports</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { title: 'Trip Report', description: 'Detailed trip analysis and statistics' },
          { title: 'Financial Report', description: 'Revenue and expense breakdown' },
          { title: 'Agent Performance', description: 'Agent productivity metrics' },
        ].map((report, index) => (
