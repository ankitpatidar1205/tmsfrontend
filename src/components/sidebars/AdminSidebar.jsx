...
const AdminSidebar = ({ isMobileOpen: externalIsMobileOpen, setIsMobileOpen: setExternalIsMobileOpen }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/trips', label: 'Trips', icon: FiTruck },
    { path: '/admin/ledger', label: 'Ledger', icon: FiDollarSign },
    { path: '/admin/users', label: 'Users', icon: FiUsers },
    { path: '/admin/profile', label: 'Agent Profile', icon: FiUsers },
    { path: '/admin/disputes', label: 'Disputes', icon: FiAlertCircle },
